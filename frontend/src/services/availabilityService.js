...
export const deleteAvailabilityByTinyHouseId =(tinyHouseId) => request(`/Availability/tinyhouse/${tinyHouseId}`, 'DELETE');
export const updateAvailabilityByTinyHouseId=(tinyHouseId) => request(`/Availability/tinyhouse/${tinyHouseId}`,'UPDATE');
